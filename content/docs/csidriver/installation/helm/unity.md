...
3. Edit `myvalues.yaml` to set the following parameters for your installation:
    ...
    The following table lists the primary configurable parameters of the Unity XT driver chart and their default values. More detailed information can be found in the [`values.yaml`](https://github.com/dell/helm-charts/blob/release-v1.8.0/charts/csi-unity/values.yaml) file in this repository.
